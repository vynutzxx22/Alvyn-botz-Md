...
//group target \\
const reply = (teks) => {
            GojoMdNx.sendMessage(m.chat, { text: teks, contextInfo:{"externalAdReply": {"title": ` ${global.botname}`,"body": `© ｖｙｎｕｔｚｘｘ２２`, "previewType": "PHOTO","thumbnailUrl": ``,"thumbnail": fs.readFileSync(`./GojoMedia/gojo.jpg`),"sourceUrl": "https://instagram.com/vynutzxx22"}}}, { quoted: m})
        }
...
break
	    ...
	    break
            ...
            break
case 'smeme': case 'stickermemex': case 'stickmemex': {
...
🔗 Url : ${anu.url}`,
	    ...
	    case 'ytmp3': case 'getmusic': case 'ytaudio': {
                ...
                GojoMdNx.sendMessage(m.chat, { image: { url: media.thumb }, jpegThumbnail:buf, caption: `🎀 Title : ${media.title}\n📁 File Size : ${media.filesizeF}\n🔗 Url : ${isUrl(text)}\n🎦 Ext : MP3\n👍 Resolution : ${args[1] || '128kbps'}`, { quoted: m }),
            ...
            case 'ytmp4': case 'getvideo': case 'ytvideo': {
                ...
                if (media.filesize >= 999999) return reply('File Over Limit '+util.format(media))
                buf = await getBuffer(media.thumb)
                GojoMdNx.sendMessage(m.chat, { video: { url: media.dl_link }, jpegThumbnail:buf, mimetype: 'video/mp4', fileName: `${media.title}.mp4`, caption: `🎀 Title : ${media.title}\n📁 File Size : ${media.filesizeF}\n🔗 Url : ${isUrl(text)}\n🎦 Ext : MP4\n👍 Resolution : ${args[1] || '360p'}` }, { quoted: m }),
...
View List Of Messages With ${prefix}listmsg`)
	    ...
	    case 'anonymous': {
            ...
            case 'tes': case 'runtime': case 'test': {
                reply(`*🚀 Bot Sudah Aktif Selama : ${runtime(process.uptime())}*`)
            }
            break
...
┃╠ ${prefix}report [bug]
┃╚═════════════✪
┗━━「 ${pushname} 」━⭓`,unicorn, [{"urlButton": {"displayText": "YouTube 📍","url": `${sc}`}},{"urlButton": {"displayText": "📢 My Instagram","url": `${ig}`}},{"quickReplyButton": {"displayText": "💰Sewa Bot","id": 'donate'}},{"quickReplyButton": {"displayText": "👤 Owner","id": 'owner'}}] )
break
...
┃╠${prefix}delvote
┃╚═════════════✪
┗━━「 ${pushname} 」━⭓`,unicorn, [{"urlButton": {"displayText": "🌐 My Web","url": `${sc}`}},{"urlButton": {"displayText": "📢 My Instagram","url": `${ig}`}},{"quickReplyButton": {"displayText": "💰Sewa Bot","id": 'donate'}},{"quickReplyButton": {"displayText": "👤 Owner","id": 'owner'}}] )
break
